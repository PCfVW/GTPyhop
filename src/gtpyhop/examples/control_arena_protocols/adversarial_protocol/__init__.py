"""
Adversarial Protocol Example for GTPyhop

Extends the Defer to Trusted micro-protocol with adversarial analysis.
The untrusted model may operate honestly or embed a side task with
varying subtlety. A monitor maps subtlety to suspicion via calibrated
detection rates. Analysis determines whether the protocol catches attacks.

Domain: 7 actions, 7 methods (2 for m_generate_output, 2 for m_route_output)
Scenarios: 8 (3 SAFE, 3 VULNERABILITY, 1 OVER-SENSITIVE, 1 honest-accepted)
