"""
Candidate Planning Poetry HTN Domain for GTPyhop

This package demonstrates multi-candidate rhyme selection for poetry generation.
Instead of selecting a single rhyme target directly, the domain generates N
candidate end-words, ranks them by rhyme quality and semantic fit, then commits
the top-ranked candidate as the line's target. This models Anthropic's finding
that the LLM maintains multiple candidate words simultaneously.
...
Supported forms:
  ...
  - Limerick (AABBA, 5 lines, 27 actions)
