"""
Defer to Resample Protocol Example for GTPyhop

Models the "Defer to Resample" micro-protocol from the Control Arena
AI safety framework. When output suspicion is high, the protocol
generates additional samples and monitors each. Accepts the first
low-suspicion sample, or defers to the trusted model after exhausting
the sample budget.

Domain: 6 actions, 5 methods (3 for m_route_or_resample with recursive resampling)
Scenarios: 6 (3 accept-on-Nth, 2 defer, 1 immediate-accept)
