"""
Structured Poetry HTN Domain for GTPyhop

This package demonstrates HTN planning for neuro-symbolic poetry generation with:
...
Supported forms:
  ...
  - Limerick (AABBA, 5 lines, 17 actions)
